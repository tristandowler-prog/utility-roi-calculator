    ...
    <div class="logic-grid">
        ...
        <div>
            ...
            <p style="font-size:0.95rem; line-height:1.6; color:{MUTED};">
                ...
                This enables GIS Intel Cells to track the leading edge
                of floodwaters through cloud and night conditions,
        ...
        <div>
            ...
            <p style="font-size:0.95rem; line-height:1.6; color:{MUTED};">
                ...
                Flood Insights delivers building-level flood depth data.

                This enables precise asset matching, ensuring
                light vehicles avoid impassable zones and reducing
                operational washouts, delays, and fleet damage.
